...
function register_ocean_Team() {
    ...
    $labels = array( 
        ...
        'search_items' => __( 'Search Teams', 'ot_team' ),

        'not_found' => __( 'No Teams found', 'ot_team' ),

        'not_found_in_trash' => __( 'No Teams found in Trash', 'ot_team' ),

        'parent_item_colon' => __( 'Parent Team:', 'ot_team' ),
